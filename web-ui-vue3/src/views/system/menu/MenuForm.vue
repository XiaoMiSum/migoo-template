    ...
    >
      ...
      <el-form-item label="菜单类型" prop="type">
        <el-radio-group v-model="formData.type">
          <el-radio-button v-for="dict in MENU_TYPE_ENUMS" :key="dict.key" :label="dict.key">
            {{ dict.label }}
          </el-radio-button>
        </el-radio-group>
      </el-form-item>
      ...
      <el-form-item v-if="formData.type !== 3" label="页面类型">
        ...
        <el-radio-group v-model="formData.pageType">
          ...
          <el-radio key="2" :label="2" border>后台</el-radio>
        </el-radio-group>
      </el-form-item>
    </el-form>
    <template #footer>
...
import { COMMON_STATUS_ENUMS, MENU_TYPE_ENUMS } from '@/utils/enums'
