...
INSERT INTO `sys_role` (`id`, `name`, `code`, `sort`, `status`, `type`, `remark`, `deleted`, `creator`, `create_time`,
                        `updater`, `update_time`)
VALUES (2, '开发者', 'developer', 1, 1, 2, '开发者', 0, '超级管理员', '2022-05-14 13:14:56', '超级管理员', '2022-05-14 13:14:56');
INSERT INTO `sys_role` (`id`, `name`, `code`, `sort`, `status`, `type`, `remark`, `deleted`, `creator`, `create_time`,
                        `updater`, `update_time`)
...
INSERT INTO `sys_user` (`id`, `phone`, `password`, `name`, `avatar`, `status`, `gender`, `dept_id`, `post_ids`, `email`,
                        `deleted`, `creator`, `create_time`, `updater`, `update_time`)
VALUES (2, 'admin', '$2a$10$iVIWjqlwmlYU4IjDFDSFFOD5jYWQMVsJ2E6fV5SVkZXKO4QrhNK9.', '管理员', NULL, 1, NULL, 1, '[]',
        NULL, 0, '超级管理员', '2022-07-16 21:52:15', '管理员', '2022-07-16 22:44:59');
INSERT INTO `sys_user` (`id`, `phone`, `password`, `name`, `avatar`, `status`, `gender`, `dept_id`, `post_ids`, `email`,
                        `deleted`, `creator`,`create_time`, `updater`, `update_time`)
VALUES (3, 'developer', '$2a$10$DmzOXDEemQOXtQjEHDnMqOcMLi0wjuYluTDSAEvA3VpYOAn9Zh3KC', '开发者', NULL, 1, 0, 2, '[]',
