    ...
    >
      ...
      <el-table-column prop="timeoutType" label="超时时间" width="150">
        <template slot-scope="scope">
          <enum-tag :enums="REDIS_TIMEOUT_ENUMS" :value="scope.row.timeoutType" />
...
<script>
import { getCache, getKeyList } from '@/api/developer/redis'
import * as echarts from 'echarts'
import { REDIS_TIMEOUT_ENUMS } from '@/utils/enums'
...
export default {
  ...
  data() {
    return {
      ...
      keyListLoad: true,
      keyList: [],
      REDIS_TIMEOUT_ENUMS: REDIS_TIMEOUT_ENUMS
    }
  },
  created() {
    this.getList()
