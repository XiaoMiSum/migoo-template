<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          v-hasPermi="['developer:generator:add']"
          type="info"
          plain
          icon="el-icon-upload"
          size="mini"
    ...
    <el-table v-loading="loading" :data="tableList">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button v-hasPermi="['developer:generator:preview']" type="text" size="small" icon="el-icon-view" @click="handlePreview(scope.row)">预览</el-button>
          <el-button v-hasPermi="['developer:generator:edit']" type="text" size="small" icon="el-icon-edit" @click="handleEditTable(scope.row)">编辑</el-button>
          <el-button v-hasPermi="['developer:generator:remove']" type="text" size="small" icon="el-icon-delete" @click="handleDelete(scope.row)">删除</el-button>
          <el-button v-hasPermi="['developer:generator:download']" type="text" size="small" icon="el-icon-download" @click="handleGenTable(scope.row)">生成代码</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="importSQL.title" :visible.sync="importSQL.open" width="800px" append-to-body>
      <el-form ref="importSQLForm" :model="importSQL.form" :rules="importSQL.rules" label-width="120px">
        <el-form-item label="" prop="sql">
          <el-input v-model="importSQL.form.sql" type="textarea" rows="20" style="width: 650px;" placeholder="请输入建 SQL 语句" />
        </el-form-item>
      </el-form>
