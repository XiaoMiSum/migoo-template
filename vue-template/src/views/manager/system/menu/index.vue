          ...
          <el-col :span="12">
            <el-form-item v-if="form.type !== 3" label="显示状态">
              ...
              <el-radio-group v-model="form.visible">
                <el-radio :key="true" :label="1">显示</el-radio>
                <el-radio :key="false" :label="0">隐藏</el-radio>
              </el-radio-group>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item v-if="form.type === 2" label="显示状态">
              ...
              <el-radio-group v-model="form.keepAlive">
                <el-radio :key="true" :label="1">缓存</el-radio>
                <el-radio :key="false" :label="0">不缓存</el-radio>
              </el-radio-group>
            </el-form-item>
          </el-col>
        </el-row>
...
<script>
import { listData, getData, delData, addData, updateData } from '@/api/manager/menu'
